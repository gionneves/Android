...
public class ArDois extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        autoCompleteTextView03 = findViewById(R.id.actvBTUs_ArDois);
        ...
        autoCompleteTextView01 = findViewById(R.id.actvMarca_ArDois);
        ...
        autoCompleteTextView02 = findViewById(R.id.actvModelo_ArDois);
        ...
        editText = findViewById(R.id.etAdicional_ArDois);
        textView = findViewById(R.id.caracterText);
